...
function OrbitalCenter() {
  return (
    ...
    >
      <Ring diameter={320} sx={{ borderColor: "rgba(13,241,217,0.1)" }} />
      <Ring diameter={268} sx={{ borderColor: "rgba(13,241,217,0.06)" }} />
      <Ring
        diameter={200}
        sx={{
          borderColor: "rgba(13,241,217,0.6)",
          boxShadow: "inset 0 0 30px rgba(13,241,217,0.14)",
        }}
      />
      ...
      >
        <Box
          ...
          aria-hidden
          sx={{ filter: "drop-shadow(0 0 18px rgba(13,241,217,0.65))" }}
        >
          <path d={EMBLEM_PATH_A} fill={ACCENT} />
