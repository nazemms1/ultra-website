  ...
  return (
    <Box
      ...
      sx={{
        ...
        "&::before": {
          ...
          height: "140px",
          background:
            "linear-gradient(to bottom, #121212 0%, transparent 100%)",
          zIndex: 2,
          pointerEvents: "none",
        },
    ...
    >
      ...
      >
        ...
        >
          Let's talk about your product, your users, and how Ultrawares can help
          you ship it.
        </Typography>
        ...
        <a
          ...
          onMouseEnter={(e) => {
            ...
            (e.currentTarget as HTMLAnchorElement).style.boxShadow =
              "0px 0px 40px 0px #01B1B199";
          }}
          onMouseLeave={(e) => {
            (e.currentTarget as HTMLAnchorElement).style.opacity = "1";
            (e.currentTarget as HTMLAnchorElement).style.boxShadow =
              "0px 0px 28px 0px #01B1B180";
          }}
        >
          Start a Project
        </a>
