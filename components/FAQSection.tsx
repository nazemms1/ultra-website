  ...
  return (
    ...
    >
      ...
      <Box sx={{
        ...
        height: '861px',
        borderRadius: '9999px',
        background: 'radial-gradient(70.71% 70.71% at 50% 50%, rgba(13,241,217,0.28) 0%, rgba(13,241,217,0.06) 50%, rgba(0,0,0,0) 70%)',
        filter: 'blur(60px)',
        pointerEvents: 'none',
        zIndex: 0,
      }} />
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            ...
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" stroke="#0DF1D9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
              </svg>
            </Box>
            <Box>
              <Typography sx={{ fontFamily: "'Rajdhani', sans-serif", fontWeight: 600, fontSize: '14px', color: '#fff', lineHeight: '20px' }}>
                Still have questions?
              </Typography>
              <Typography sx={{ fontFamily: "'Rajdhani', sans-serif", fontWeight: 400, fontSize: '12px', color: 'rgba(255,255,255,0.38)', lineHeight: '18px' }}>
