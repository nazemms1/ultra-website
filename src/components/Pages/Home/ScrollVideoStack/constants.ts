...
export const SCROLL_VIDEO_CONTENT_OPACITY = 0.25 // 0.72

/** Scroll progress span used for Hero↔Partners and Methodologies↔CTA edge fades. */
export const SCROLL_VIDEO_EDGE_FADE = 0.07
