...
export default function Portfolio() {
  return (
    <Box
      component="section"
      id="portfolio"
      sx={{ position: 'relative', py: 12, px: 3, bgcolor: 'background.default' }}
    >
      <Box
        sx={theme => ({
          pointerEvents: 'none',
      ...
      <Box sx={{ position: 'relative', zIndex: 1, maxWidth: 1280, mx: 'auto' }}>
        ...
        >
          <Grid size={{ xs: 12, md: 7 }}>
            ...
            >
              OUR <ShimmerText>PORTFOLIO</ShimmerText>
            </Typography>
          </Grid>
          <Grid size={{ xs: 12, md: 5 }}>
            ...
            >
              Explore how we implement modern technologies to solve complex infrastructure and
              design problems.
            </Typography>
          </Grid>
        </Grid>
      ...
      >
        <Box>
          ...
          >
            ...
            <Box
              data-portfolio-arrow
              sx={{ opacity: 0, transition: 'all 0.3s', display: 'flex', color: 'primary.main' }}
            >
